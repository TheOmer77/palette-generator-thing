...
bg-primary-95 text-base font-medium text-primary-20 shadow shadow-primary-50/50
...
dark:text-primary-80 dark:shadow-primary-20/50 dark:focus-visible:bg-primary-20
dark:active:bg-primary-20 [&>.icon]:text-2xl`,
