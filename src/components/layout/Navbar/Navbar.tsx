...
export const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={cn(
          `fixed top-0 z-20 grid h-16 w-full max-w-screen-2xl
...
before:via-35% before:to-background/0 before:opacity-0 before:transition-opacity
md:left-1/2 md:-translate-x-1/2 md:grid-cols-[theme(spacing.80),1fr]
md:bg-transparent md:before:end-0 md:before:h-24
